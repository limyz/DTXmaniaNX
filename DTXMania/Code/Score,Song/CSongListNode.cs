...
namespace DTXMania
{
	...
	internal class CSongListNode
	{
		...
		public CHitRanges DrumHitRanges = new CHitRanges(defaultRange: -1);
		public CHitRanges DrumPedalHitRanges = new CHitRanges(defaultRange: -1);
		public CHitRanges GuitarHitRanges = new CHitRanges(defaultRange: -1);
		public CHitRanges BassHitRanges = new CHitRanges(defaultRange: -1);
		public int nスコア数;
		...
		public CSongListNode ShallowCopyOfSelf()
        {
			...
			newNode.DrumHitRanges.CopyFrom(DrumHitRanges);
			newNode.DrumPedalHitRanges.CopyFrom(DrumPedalHitRanges);
			newNode.GuitarHitRanges.CopyFrom(GuitarHitRanges);
			newNode.BassHitRanges.CopyFrom(BassHitRanges);
