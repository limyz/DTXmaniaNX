...
//		public bool bBASS演奏で直前のBASSを消音する;
        ...
        private static void tミラーチップのチャンネルを指定する( CDTX.CChip chip, EChannel nミラー化前チャンネル番号 )
        {
        ...
        private static void t乱数を各チャンネルに指定する(int[] nシンバルグループ, int[] nタムグループ, CDTX.CChip chip, EChannel nランダム化前チャンネル番号)
        {
        ...
        private static void t乱数を各チャンネルに指定する_クラシック(int[] n乱数排列数列, CDTX.CChip chip, EChannel nランダム化前チャンネル番号)
        {
            switch (nランダム化前チャンネル番号)
            {
                case EChannel.HiHatClose:
