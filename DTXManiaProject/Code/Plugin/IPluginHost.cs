namespace DTXMania
{
	...
	public interface IPluginHost
	{
		...
		/// <para>DTXMania 本体は入力データのポーリングのみを行い、他のプラグインに対しては、OnUpdateAndDraw() の2つの入力に null を渡します。</para>
		/// </summary>
		...
		/// <para>DTXMania 本体はポーリング以外の入力処理を開始し、他のプラグインに対しては、OnUpdateAndDraw() の2つの引数に有効な値を渡します。</para>
		/// </summary>
		/// <param name="act">宣言するプラグイン（すなわち this を指定する）</param>
