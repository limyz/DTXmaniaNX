...
namespace FDK
{
	public class CConversion  // C変換
	{
		...
		public static int nRoundToRange( int nValue, int nMin, int nMax )
		{
			if( nValue < nMin )
				return nMin;
		...
		public static int nGetNumberIfInRange( string strNumber, int nMin, int nMax, int nDefaultValueOnFailure )
		{
			int num;
        ...
        public static int nRoundToRange(string str数値文字列, int n最小値, int n最大値, int n取得失敗時のデフォルト値)
        {
