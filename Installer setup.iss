...
DefaultDirName={userappdata}\{#MyAppSetupName}
UninstallDisplayIcon={app}\{#MyAppExeName}
//Admin is required to install DirectX Runtime
...
Source: "Runtime\Licenses\*"; DestDir: "{app}\Licenses"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  if not IsDotNetInstalled(net471, 0) then begin
    AddDependency('dotnetfx471.exe',
      '/lcid ' + IntToStr(GetUILanguage) + ' /passive /norestart',
      '.NET Framework 4.7.1',
      'https://download.microsoft.com/download/8/E/2/8E2BDDE7-F06E-44CC-A145-56C6B9BBE5DD/NDP471-KB4033344-Web.exe',
      '', False, False, False);
  end;
#endif
