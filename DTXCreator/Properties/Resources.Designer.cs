...
namespace DTXCreator.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   027(sizuku Edition) に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        internal static string strプレビュー動画ファイル選択ダイアログのタイトル
        {
            get
            {
                return ResourceManager.GetString("strプレビュー動画ファイル選択ダイアログのタイトル", resourceCulture);
            }
        }

        internal static string strプレビュー動画ファイル選択ダイアログのフィルタ
        {
            get
            {
                return ResourceManager.GetString("strプレビュー動画ファイル選択ダイアログのフィルタ", resourceCulture);
            }
        }
