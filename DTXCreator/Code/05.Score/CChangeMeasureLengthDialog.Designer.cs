...
{
	partial class CChangeMeasureLengthDialog
	{
		/// <summary>
		/// 必要なデザイナ変数です。
		/// </summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager( typeof( CChangeMeasureLengthDialog ) );
